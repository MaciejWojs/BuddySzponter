        ...
        <section class="actions" style="-webkit-app-region: no-drag">
          <div class="action-group">
            <button
              ...
              :title="
                isManualGuestLock ? 'Blokada goscia aktywna' : 'Kliknij, aby zablokowac goscia'
              "
          ...
          <div class="action-group">
            <button
              class="tool-btn"
              :class="pinned ? 'is-pin-on' : ''"
              :title="pinned ? 'Odepnij pasek' : 'Przypnij pasek'"
              @click="togglePin"
            >
              <svg viewBox="0 0 24 24" class="icon">
                <path fill="currentColor" d="M16 9V4h1V2H7v2h1v5l-2 2v2h5v7h2v-7h5v-2l-2-2Z" />
              </svg>
            </button>

            <button class="tool-btn" title="Minimalizuj pasek" @click="handleMinimize">
              <svg viewBox="0 0 24 24" class="icon">
