<template>
    <button
        ...
        class="select-button"
        :class="{ 'select-button--disabled': props.disabled, 'select-button--loading': props.loading, 'select-button--active': props.active }"
        @click="emit('click', $event)"
    >
        <span v-if="props.loading" class="select-button__spinner" />
        <span class="select-button__label"><slot>{{ props.label }}</slot></span>
